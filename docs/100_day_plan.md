...
- [X] Initialize Python 3.12 virtual environment, install `fastapi uvicorn sqlalchemy asyncpg alembic pydantic-settings python-dotenv structlog` (30 min)
- [X] Create `pyproject.toml` with project metadata and tool config (black, ruff, mypy) (30 min)
